...
async function runSync() {
    ...
    try {
        ...
        debug(`Equipment sync function completed; retrieved ${equipmentList.length} pieces of equipment`);
    }
    catch (error) {
...
if (syncFunction !== undefined) {
    ...
    const scheduledTask = new ScheduledTask(`Equipment Sync (${syncSource})`, runSync, {
        schedule: {
