...
const attachmentStoragePath = getConfigProperty(
  'application.attachmentStoragePath'
)
...
async function transcribeFiles(): Promise<void> {
  const attachmentsToTranscribe =
    await getWorkOrderAttachmentsForTranscription()
