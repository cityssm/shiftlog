...
Work Order Types define the categories of work orders that can be created.

![Work Order Types](./images/adminWorkOrderTypes.png)
...
4. Click **Add Work Order Type** to create the type
...
5. Click **Update Work Order Type** to apply changes.

## Deleting Work Order Types

**Note**: Deleting a work order type will not delete work orders that use that type.
It will only prevent future use of the type.
