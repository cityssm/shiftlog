...
var getWorkOrderMilestones_js_1 = require("../../database/workOrders/getWorkOrderMilestones.js");
...
function handler(request, response) {
    return __awaiter(this, void 0, void 0, function () {
        var shift, shiftCrews, shiftEmployees, shiftEquipment, shiftWorkOrders, allMilestones, _i, shiftWorkOrders_1, workOrder, milestones;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 5:
                    ...
                    allMilestones = [];
                    _i = 0, shiftWorkOrders_1 = shiftWorkOrders;
                    _a.label = 6;
                case 6:
                    if (!(_i < shiftWorkOrders_1.length)) return [3 /*break*/, 9];
                    workOrder = shiftWorkOrders_1[_i];
                    return [4 /*yield*/, (0, getWorkOrderMilestones_js_1.default)(workOrder.workOrderId.toString())];
                case 7:
                    milestones = _a.sent();
                ...
                case 9:
                    response.render('print/shift', {
                        headTitle: "".concat((0, config_helpers_js_1.getConfigProperty)('shifts.sectionNameSingular'), " #").concat(shift.shiftId),
                        shift: shift,
