...
var getShiftTimeDataListItems_js_1 = require("../../database/shifts/getShiftTimeDataListItems.js");
var getShiftTypeDataListItems_js_1 = require("../../database/shifts/getShiftTypeDataListItems.js");
...
function handler(request, response) {
    return __awaiter(this, void 0, void 0, function () {
        var shift, shiftCrews, shiftEmployees, shiftEquipment, shiftWorkOrders, supervisors, shiftTypes, shiftTimes;
        var _a, _b, _c, _d, _e;
        return __generator(this, function (_f) {
            switch (_f.label) {
                ...
                case 1:
                    ...
                    else if (!((_b = (_a = request.session.user) === null || _a === void 0 ? void 0 : _a.userProperties.shifts.canManage) !== null && _b !== void 0 ? _b : false) &&
                        shift.supervisorUserName !== ((_c = request.session.user) === null || _c === void 0 ? void 0 : _c.userName)) {
                        response.redirect("".concat(redirectRoot, "/").concat(shift.shiftId, "/?error=forbidden"));
                        return [2 /*return*/];
                    }
                    else if (shift.recordLock_dateTime !== null &&
                        shift.recordLock_dateTime !== undefined &&
                        Date.now() >= shift.recordLock_dateTime.getTime()) {
                        response.redirect("".concat(redirectRoot, "/").concat(shift.shiftId, "/?error=locked"));
                        return [2 /*return*/];
                    }
                ...
                case 3:
                    shiftEmployees = _f.sent();
                    return [4 /*yield*/, (0, getShiftEquipment_js_1.default)(request.params.shiftId)];
                case 4:
                    shiftEquipment = _f.sent();
                    return [4 /*yield*/, (0, getShiftWorkOrders_js_1.default)(request.params.shiftId)];
                case 5:
                    shiftWorkOrders = _f.sent();
                    return [4 /*yield*/, (0, getEmployees_js_1.default)({ isSupervisor: true })];
                case 6:
                    supervisors = _f.sent();
                    if (!((_e = (_d = request.session.user) === null || _d === void 0 ? void 0 : _d.userProperties.shifts.canManage) !== null && _e !== void 0 ? _e : false)) {
                        supervisors = supervisors.filter(function (supervisor) { var _a; return supervisor.userName === ((_a = request.session.user) === null || _a === void 0 ? void 0 : _a.userName); });
                    }
                    return [4 /*yield*/, (0, getShiftTypeDataListItems_js_1.default)(request.session.user)];
                case 7:
                    shiftTypes = _f.sent();
                    return [4 /*yield*/, (0, getShiftTimeDataListItems_js_1.default)(request.session.user)];
                case 8:
                    shiftTimes = _f.sent();
