import getWorkOrders from '../../database/workOrders/getWorkOrders.js';
export default async function handler(request, response) {
    const workOrdersResults = await getWorkOrders(request.body, request.body, request.session.user);
    response.json({
        success: true,
