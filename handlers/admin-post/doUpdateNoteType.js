...
var updateNoteType_js_1 = require("../../database/noteTypes/updateNoteType.js");
var getNoteTypes_js_1 = require("../../database/noteTypes/getNoteTypes.js");
function handler(request, response) {
    return __awaiter(this, void 0, void 0, function () {
        var noteTypeId, noteType, userGroupId, isAvailableWorkOrders, isAvailableShifts, isAvailableTimesheets, success, noteTypes;
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, updateNoteType_js_1.default)({
