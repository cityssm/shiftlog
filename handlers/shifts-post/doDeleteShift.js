...
var deleteShift_js_1 = require("../../database/shifts/deleteShift.js");
...
function handler(request, response) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0: return [4 /*yield*/, (0, deleteShift_js_1.default)(request.body.shiftId, (_b = (_a = request.session.user) === null || _a === void 0 ? void 0 : _a.userName) !== null && _b !== void 0 ? _b : '')];
                case 1:
                    success = _c.sent();
                    if (success) {
                        response.json({
