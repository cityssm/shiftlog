...
var getShifts_js_1 = require("../../database/shifts/getShifts.js");
function handler(request, response) {
    return __awaiter(this, void 0, void 0, function () {
        var shiftsResults;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, getShifts_js_1.default)(request.body, request.body, request.session.user)];
                case 1:
                    shiftsResults = _a.sent();
                    response.json({
                        success: true,
