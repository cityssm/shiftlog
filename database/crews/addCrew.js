            ...
            switch (_b.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, pool
                            ...
                            .input('userGroupId', (_a = crewForm.userGroupId) !== null && _a !== void 0 ? _a : null)
                ...
                case 2:
                    result = _b.sent();
                    return [2 /*return*/, result.recordset[0].crewId];
            }
        });
    });
}
