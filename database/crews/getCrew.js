...
function getCrew(crewId) {
    return __awaiter(this, void 0, void 0, function () {
        var pool, crewResult, crew, membersResult, equipmentResult;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 4:
                    equipmentResult = _a.sent();
                    return [2 /*return*/, __assign(__assign({}, crew), { members: membersResult.recordset, equipment: equipmentResult.recordset })];
            }
        });
    });
}
