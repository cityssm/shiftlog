...
exports.default = updateCrewEquipment;
var database_helpers_js_1 = require("../../helpers/database.helpers.js");
function updateCrewEquipment(crewId, equipmentNumber, employeeNumber) {
            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, pool
                            ...
                            .input('employeeNumber', employeeNumber !== null && employeeNumber !== void 0 ? employeeNumber : null)
