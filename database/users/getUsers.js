...
function getUsers() {
    return __awaiter(this, void 0, void 0, function () {
        var pool, usersResult, users, _i, users_1, user, settingsResult, settings, _a, _b, row;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 3:
                    ...
                    user = users_1[_i];
                    return [4 /*yield*/, pool.request().input('userName', user.userName)
                            .query(/* sql */ "\n        select settingKey, settingValue\n        from ShiftLog.UserSettings\n        where userName = @userName\n      ")];
                case 4:
                    settingsResult = _c.sent();
                    settings = {};
                    for (_a = 0, _b = settingsResult.recordset; _a < _b.length; _a++) {
                        row = _b[_a];
