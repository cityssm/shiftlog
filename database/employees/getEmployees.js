...
function getEmployees() {
    return __awaiter(this, arguments, void 0, function (filters, orderBy) {
        var pool, result;
        var _a, _b;
            ...
            switch (_c.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, pool
                            ...
                            .input('isSupervisor', filters.isSupervisor).query(/* sql */ "\n      select employeeNumber, firstName, lastName,\n        userName, isSupervisor,\n        phoneNumber, phoneNumberAlternate, emailAddress,\n        userGroupId,\n        recordSync_isSynced, recordSync_source, recordSync_dateTime,\n        recordCreate_userName, recordCreate_dateTime,\n        recordUpdate_userName, recordUpdate_dateTime\n      from ShiftLog.Employees\n      where\n        instance = @instance\n        ".concat(((_a = filters.includeDeleted) !== null && _a !== void 0 ? _a : false) ? '' : 'and recordDelete_dateTime is null', "\n        ").concat(filters.employeeNumber === undefined ? '' : 'and employeeNumber = @employeeNumber', "\n        ").concat(filters.isSupervisor === undefined ? '' : 'and isSupervisor = @isSupervisor', "\n      order by ").concat((_b = orderByOptions[orderBy]) !== null && _b !== void 0 ? _b : orderByOptions.name, "\n  "))];
                case 2:
                    result = _c.sent();
