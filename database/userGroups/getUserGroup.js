...
function getUserGroup(userGroupId) {
    return __awaiter(this, void 0, void 0, function () {
        var pool, groupResult, userGroup, membersResult;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    userGroup = groupResult.recordset[0];
                    return [4 /*yield*/, pool.request()
                            .input('userGroupId', userGroupId)
                            .query(/* sql */ "\n      select userName\n      from ShiftLog.UserGroupMembers\n      where userGroupId = @userGroupId\n      order by userName\n    ")];
                case 3:
                    membersResult = _a.sent();
                    userGroup.members = membersResult.recordset.map(function (row) { return row.userName; });
                    userGroup.memberCount = userGroup.members.length;
                    return [2 /*return*/, userGroup];
            }
        });
    });
}
