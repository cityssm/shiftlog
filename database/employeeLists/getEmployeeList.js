        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    employeeList = listResult.recordset[0];
                    return [4 /*yield*/, pool
                            .request()
                            .input('instance', (0, config_helpers_js_1.getConfigProperty)('application.instance'))
                            .input('employeeListId', employeeListId)
                ...
                case 3:
                    ...
                    return [2 /*return*/, __assign(__assign({}, employeeList), { members: membersResult.recordset })];
            }
        });
    });
}
