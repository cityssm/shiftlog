...
router.get('/:apiKey/dataListItems/:dataListKey', apiGetHandler, handler_dataListItems);
router.get('/:apiKey/workOrders/:workOrderId.ics', apiGetHandler, handler_workOrder);
router.get('/:apiKey/workOrderDigest', apiGetHandler, handler_workOrderDigest);
