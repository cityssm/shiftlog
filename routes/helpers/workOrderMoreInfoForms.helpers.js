export const availableWorkOrderMoreInfoForms = {
    accessibility: {
        ...
        formFields: {
            ...
            moreInfo_accessibility_assistiveTechnologyUsed: 'Assistive Technology Used',
            moreInfo_accessibility_assistiveDevicesNeeded: 'Recommended Assistive Devices Needed',
