...
export interface NoteTypeTemplate {
     ...
     */
    noteType: Omit<NoteType, 'noteTypeId' | 'recordCreate_dateTime' | 'recordCreate_userName' | 'recordDelete_dateTime' | 'recordDelete_userName' | 'recordUpdate_dateTime' | 'recordUpdate_userName' | 'userGroupName'>;
    /**
     * Field definitions (omitting auto-generated fields)
     */
    fields: Array<Omit<NoteTypeField, 'noteTypeFieldId' | 'noteTypeId' | 'recordCreate_dateTime' | 'recordCreate_userName' | 'recordDelete_dateTime' | 'recordDelete_userName' | 'recordUpdate_dateTime' | 'recordUpdate_userName'>>;
}
