...
(() => {
    ...
    const menuTabElements = shiftTabsContainerElement.querySelectorAll('.menu a');
    const tabContainerElements = shiftTabsContainerElement.querySelectorAll('.tabs-container > div');
