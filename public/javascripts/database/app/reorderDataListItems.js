...
exports.default = reorderDataListItems;
var database_helpers_js_1 = require("../../helpers/database.helpers.js");
function reorderDataListItems(form) {
    return __awaiter(this, void 0, void 0, function () {
        var pool, _i, _a, _b, index, dataListItemId, _c;
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 2:
                    _d.trys.push([2, 7, , 8]);
                    _i = 0, _a = form.dataListItemIds.entries();
                    _d.label = 3;
                case 3:
                    if (!(_i < _a.length)) return [3 /*break*/, 6];
                    _b = _a[_i], index = _b[0], dataListItemId = _b[1];
...
//# sourceMappingURL=reorderDataListItems.js.map