...
(function () {
    ...
    (_c = document
        .querySelector('#filter--isValidApiKey')) === null || _c === void 0 ? void 0 : _c.addEventListener('change', function () {
        currentPage = 1;
        loadAuditLogs();
    });
    // Initial load
