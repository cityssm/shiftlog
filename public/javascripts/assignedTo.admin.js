(() => {
    ...
    const tbodyElement = document.querySelector('#tbody--assignedTo');
    function renderAssignedToList() {
        ...
        for (const item of assignedToList) {
            ...
            const userGroupDisplay = userGroup === undefined
    ...
    function addAssignedTo() {
        ...
        cityssm.openHtmlModal('adminAssignedTo-add', {
            ...
            onshown(modalElement, _closeModalFunction) {
                ...
                modalElement.querySelector('#addAssignedTo--assignedToName').focus();
            },
            onremoved() {
                bulmaJS.toggleHtmlClipped();
            }
    ...
    function editAssignedTo(clickEvent) {
                    ...
                    if (itemIndex !== -1) {
                        ...
                        assignedToList[itemIndex].userGroupId =
                            editForm.querySelector('#editAssignedTo--userGroupId').value === ''
                                ? undefined
                                : Number.parseInt(editForm.querySelector('#editAssignedTo--userGroupId').value, 10);
                    }
                    renderAssignedToList();
                    closeModalFunction();
                }
        ...
        cityssm.openHtmlModal('adminAssignedTo-edit', {
            ...
            onshown(modalElement, _closeModalFunction) {
                ...
                modalElement.querySelector('#editAssignedTo--assignedToName').focus();
            },
            onremoved() {
                bulmaJS.toggleHtmlClipped();
            }
